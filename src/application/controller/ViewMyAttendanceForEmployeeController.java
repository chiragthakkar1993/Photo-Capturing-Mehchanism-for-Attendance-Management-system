...
public class ViewMyAttendanceForEmployeeController implements Initializable {

	@FXML
	private TableView tableMyAttendance;
	@FXML
	...
	@FXML
	private ComboBox comboViewByMonth;
	@FXML
	private Label lblAttendedDays;
	@FXML
	private Label lblAbsentDays;

	private Stage stage;

	@Override
	public void initialize(URL arg0, ResourceBundle arg1) {
		System.out.println(tableMyAttendance);
		System.out.println(comboViewByMonth);
		...
		System.out.println(lblAbsentDays);
		System.out.println(lblAttendedDays);
		...
		// }
		// });
		tableMyAttendance.setItems(data);
